...
public class cognizant {
		...
		//This method is to enter the value and count number of options displayed and print them 
	     public void SearchCognizant(WebDriver driver) throws IOException	{
	    	 //Entering cognizant in the search bar
	    	
	    	String n = Excel.dataSet();
			driver.findElement(By.xpath("//*[@id=\"APjFqb\"]")).sendKeys(n);
			//Taking screenshot of options displayed
			  try {
					TakesScreenshot ts = ((TakesScreenshot) driver);
					File sourceFile = ts.getScreenshotAs(OutputType.FILE);
					File destinationFile = new File(System.getProperty("user.dir")+"\\Screenshot\\1)webpage.png");
	     ...
	     public void Allnumberofresults(WebDriver driver) {
			...
			//Take screenshot after click on All option
			 try {
					TakesScreenshot ts = ((TakesScreenshot) driver);
					File sourceFile = ts.getScreenshotAs(OutputType.FILE);
					File destinationFile = new File(System.getProperty("user.dir")+"\\Screenshot\\2)All.png");
					FileUtils.copyFile(sourceFile, destinationFile);
			  }
			  catch (Exception e) {
		            e.printStackTrace();
	   ...
	   //This method is to Click on "News" option 
	     public void Newsnumberofresults(WebDriver driver) {
			...
			try {
					TakesScreenshot ts = ((TakesScreenshot) driver);
					File sourceFile = ts.getScreenshotAs(OutputType.FILE);
					File destinationFile = new File(System.getProperty("user.dir")+"\\Screenshot\\3)News.png");
					FileUtils.copyFile(sourceFile, destinationFile);
			  }
			  catch (Exception e) {
		            e.printStackTrace();
	     ...
	     public void Imagenumberofresults(WebDriver driver) {
			...
			//Take screenshot after click on image option
			 try {
					TakesScreenshot ts = ((TakesScreenshot) driver);
					File sourceFile = ts.getScreenshotAs(OutputType.FILE);
					File destinationFile = new File(System.getProperty("user.dir")+"\\Screenshot\\4)Images.png");
					FileUtils.copyFile(sourceFile, destinationFile);
			  }
			  catch (Exception e) {
		            e.printStackTrace();
	     ...
	     public void Videosnumberofresults(WebDriver driver) {
			...
			//Take screenshot after click on Videos option
			 try {
					TakesScreenshot ts = ((TakesScreenshot) driver);
					File sourceFile = ts.getScreenshotAs(OutputType.FILE);
					File destinationFile = new File(System.getProperty("user.dir")+"\\Screenshot\\5)Videos.png");
					FileUtils.copyFile(sourceFile, destinationFile);
			  }
			  catch (Exception e) {
		            e.printStackTrace();
